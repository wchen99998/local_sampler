...
config = TrainingConfig(
    ...
    viz_bounds=(-6.0, 6.0),    # axis limits for saved trajectory plots
)
...
# per-slice trajectory npz/pngs, slice loss curves, a loss curve, and final trajectory plots into that directory.
PY
```
